    ...
    function renderSection(regionStaticId, sectionCode, isReadOnly) {
        ...
        items
            ...
            .forEach(function (item) {
                var $field = $('<div class="t-Form-fieldContainer ptw-checklist-field"></div>');

                $('<div class="t-Form-labelContainer"></div>')
                    .append($('<label></label>').text(item.question))
                    .appendTo($field);

                var $inputContainer = $('<div class="t-Form-inputContainer"></div>').appendTo($field);
