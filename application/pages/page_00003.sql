...
'    apex.item(''P3_IS_CHANGED'').setValue(''Y'');',
'} else {',
'    apex.item(''P3_IS_CHANGED'').setValue(''N'');',
'}'))
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(30154572229398457)
,p_event_id=>wwv_flow_imp.id(30153697799398471)
,p_event_result=>'TRUE'
...
,p_attribute_01=>'NULL;'
,p_attribute_02=>'P3_IS_CHANGED'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(30155082510398455)
,p_event_id=>wwv_flow_imp.id(30153697799398471)
,p_event_result=>'TRUE'
...
'    IF :P3_CONTROL_MEASURES_ID IS NULL THEN',
'        -- INSERT',
...
'            :P3_CM_15,',
'            :P3_CM_16',
'        ) RETURNING control_measures_id INTO :P3_CONTROL_MEASURES_ID;',
'',
...
'    END IF;',
'',
'    IF :P3_IS_CHANGED = ''Y'' THEN',
'        -- UPDATE',
'        UPDATE ptw_pro.ptw_lv_control_measures',
'        SET cm_01_site_induction = :P3_CM_01,',
...
'            modified_date = CURRENT_TIMESTAMP',
'        WHERE control_measures_id = :P3_CONTROL_MEASURES_ID;',
'',
