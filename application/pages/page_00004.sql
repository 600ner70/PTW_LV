...
'    apex.item(''P4_IS_CHANGED'').setValue(''Y'');',
'} else {',
'    apex.item(''P4_IS_CHANGED'').setValue(''N'');',
'}'))
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(30159827458375309)
,p_event_id=>wwv_flow_imp.id(30158963221375313)
,p_event_result=>'TRUE'
...
,p_attribute_01=>'NULL;'
,p_attribute_02=>'P4_IS_CHANGED'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(30160320272375307)
,p_event_id=>wwv_flow_imp.id(30158963221375313)
,p_event_result=>'TRUE'
