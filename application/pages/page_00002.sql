...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(28347491173917047)
...
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P2_IS_CHANGED'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'if (apex.page.isChanged()) {',
'    // do something, e.g. enable a save button',
'    apex.item(''P2_IS_CHANGED'').setValue(''Y'');',
'} else {',
'    apex.item(''P2_IS_CHANGED'').setValue(''N'');',
'}'))
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(28347647512917049)
,p_event_id=>wwv_flow_imp.id(28347379433917046)
,p_event_result=>'TRUE'
...
,p_attribute_01=>'NULL;'
,p_attribute_02=>'P2_IS_CHANGED'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(28347743539917050)
,p_event_id=>wwv_flow_imp.id(28347379433917046)
,p_event_result=>'TRUE'
