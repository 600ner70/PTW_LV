...
,p_read_only_when=>'P10_MONITORING_ID'
...
,p_button_redirect_url=>'f?p=&APP_ID.:15:&SESSION.::&DEBUG.:15:P15_PERMIT_ID,P15_PTW_TYPE:&P10_PERMIT_ID.,LV_MONITORING'
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(41967736199328808)
,p_branch_name=>'Refresh current page'
,p_branch_action=>'f?p=&APP_ID.:10:&SESSION.::&DEBUG.:10:P10_MONITORING_ID,P10_PERMIT_ID:&P10_MONITORING_ID.,&P10_PERMIT_ID.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(40759594892498345)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(41969353797328824)
,p_branch_name=>'Back to report - SAVE MONITORING'
,p_branch_action=>'f?p=&APP_ID.:15:&SESSION.::&DEBUG.:10:P15_PERMIT_ID,P15_PTW_TYPE:&P10_PERMIT_ID.,LV_MONITORING'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(40759672326498346)
...
,p_validation_condition=>':REQUEST IN (''SAVE_DRAFT'',''SAVE_MONITORING'')'
